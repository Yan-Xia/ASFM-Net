...
if __name__ == '__main__':
    ...
    # parser.add_argument('--list_file', default='/ASFM-Net/blender/list.txt')
    # parser.add_argument('--intrinsics_file',default='./render/intrinsics.txt')
    # parser.add_argument('--output_dir',default='./render')
    parser.add_argument('--list_file', default='./test_list.txt')
    parser.add_argument('--intrinsics_file',default='./obj530/intrinsics.txt')
    parser.add_argument('--output_dir',default='./obj530')
    parser.add_argument('--num_scans', type=int, default=530)
